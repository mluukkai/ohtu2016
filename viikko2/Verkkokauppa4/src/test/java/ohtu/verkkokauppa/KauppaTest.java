...
public class KauppaTest {
    ...
    @Test
    public void oikeatTiedotAnnetaanPankilleTilisiirrossa() {
        Pankki pankki = mock(Pankki.class);
        Viitegeneraattori viite = mock(Viitegeneraattori.class);
        Varasto varasto = mock(Varasto.class);
    ...
    public void ostetaanKaksiEriTuotetta() {
        ...
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
        when(varasto.haeTuote(2)).thenReturn(new Tuote(2, "jugurtti", 7));
    ...
    @Test
    public void testataanEttaAloitaAsiointiNollaaTiedot() {
        Pankki pankki = mock(Pankki.class);
        Viitegeneraattori viite = mock(Viitegeneraattori.class);
        Varasto varasto = mock(Varasto.class);
    ...
    public void uusiViiteJokaiselleMaksulle() {
        ...
        k.lisaaKoriin(2);
        k.tilimaksu("pekka", "12345");
        verify(pankki).tilisiirto(eq("pekka"), eq(17), eq("12345"), anyString(), eq(7));
    }
}