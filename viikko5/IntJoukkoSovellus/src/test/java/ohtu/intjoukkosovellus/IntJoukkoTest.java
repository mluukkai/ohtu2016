...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.jonostaLoytyy(10));
        assertFalse(joukko.jonostaLoytyy(5));
        assertTrue(joukko.jonostaLoytyy(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.jonostaLoytyy(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.jonostaLoytyy(11));
        joukko.poista(11);
        assertFalse(joukko.jonostaLoytyy(11));
