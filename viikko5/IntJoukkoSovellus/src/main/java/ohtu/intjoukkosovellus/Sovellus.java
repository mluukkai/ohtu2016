...
public class Sovellus {
    ...
    private static void yhdiste() {
        ...
        bJoukko = mikaJoukko();
        c = IntJoukko.teeJoukoille("yhdiste", aJoukko, bJoukko);
    ...
    private static void leikkaus() {
        ...
        System.out.print("2. joukko? ");
        bJoukko = mikaJoukko();
        c = IntJoukko.teeJoukoille("leikkaus", aJoukko, bJoukko);
    ...
    private static void erotus() {
        ...
        System.out.print("2. joukko? ");
        bJoukko = mikaJoukko();
        c = IntJoukko.teeJoukoille("erotus", aJoukko, bJoukko);
    ...
    private static void kuuluu() {
        ...
        boolean kuuluuko = joukko.jonostaLoytyy(kysLuku);
        if (kuuluuko) {
