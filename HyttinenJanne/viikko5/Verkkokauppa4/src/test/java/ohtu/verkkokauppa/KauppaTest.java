...
public class KauppaTest {
    ...
    /**
     * Test of tilisiirto method, of class Pankki.
     */
    ...
    public void ostoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaanKaksiEriTuotetta(){
        ...
        when(varasto.haeTuote(2)).thenReturn(new Tuote(2, "pirkkaolut", 6));
        // sitten testattava kauppa 
        Kauppa k = new Kauppa(varasto, pankki, viite);
        ...
        k.aloitaAsiointi();
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.lisaaKoriin(2);     // ostetaan tuotetta numero 2 eli kalia
        k.tilimaksu("pekka", "12345");
    ...
    @Test
    public void ostoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaanKaksiEriLoppu(){
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
        ...
        when(varasto.haeTuote(2)).thenReturn(new Tuote(2, "kobehärkä", 100));
        ...
        k.aloitaAsiointi();
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.lisaaKoriin(2);     // ostetaan kobehärkää
        k.tilimaksu("pekka", "12345");
