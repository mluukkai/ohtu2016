...
public class IntJoukkoTest {
    ...
    @Test
    public void yhdiste(){
        String odotettu = "{10, 3, 5, 6}";
        IntJoukko uusi=new IntJoukko();
        uusi.lisaa(5);
        uusi.lisaa(6);
        
        assertEquals(odotettu, joukko.yhdiste(uusi).toString());
    }
    ...
    public void erotus(){
        ...
        IntJoukko uusi=new IntJoukko();
        uusi.lisaa(3);
        assertEquals(odotettu, joukko.erotus(uusi).toString());
    }
    ...
    public void leikkaus(){
        ...
        uusi.lisaa(7);
        uusi.lisaa(10);
        assertEquals(odotettu, joukko.leikkaus(uusi).toString());
    }
